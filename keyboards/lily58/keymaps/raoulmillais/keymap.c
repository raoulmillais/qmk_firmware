 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LCtrl | LAlt | SYM  | /Space  /       \Enter \  | SYM  | RGUI |RCtrl |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT, KC_Z,   KC_X,   KC_C,     KC_V,   KC_B,   KC_LBRC, KC_RBRC,  KC_N,   KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,  KC_RCTL,
                  KC_LCTL, KC_LALT,  SYM,    KC_SPC,                    KC_ENT, NUM,   KC_RGUI,  KC_RCTL),
...
[_NUM] = LAYOUT(
  ...
  _______, KC_0,    KC_1,   KC_2,     KC_3,   KC_HASH,  _______, _______, KC_PSCR, KC_INS, KC_INS,   KC_DEL,  _______, _______,
