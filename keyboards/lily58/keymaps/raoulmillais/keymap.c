 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LCtrl | LAlt | SYM  | /Enter  /       \Space \  | SYM  | RGUI |RCtrl |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT, KC_Z,   KC_X,   C_NUM,    V_SYM,  KC_B,   KC_LBRC, KC_RBRC,  KC_N,   M_SYM, COMM_NUM, KC_DOT,  KC_SLSH,  KC_RSFT,
                  KC_LCTL, KC_LALT,  SYM,    KC_ENT,                    KC_SPC, NUM,   KC_RGUI,  KC_RCTL),
...
[_SYM] = LAYOUT(
  ...
  _______, KC_PERC,KC_CIRC,KC_LBRC,  KC_RBRC, KC_TILD,  _______, _______, KC_GRV,  KC_DQUO, KC_QUOT,  KC_UNDS, KC_TILD, _______,
...
[_NUM] = LAYOUT(
  ...
  _______, KC_MINS, KC_7,   KC_8,     KC_9,   KC_ASTR,                    _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
  _______, KC_CIRC, KC_4,   KC_5,     KC_6,   KC_PLUS,                    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
  _______, KC_0,    KC_1,   KC_2,     KC_3,   KC_HASH,  _______, _______, _______, KC_PSCR, KC_INS, KC_INS,   KC_DEL,  _______,
